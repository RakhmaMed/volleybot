...
5. **Сертификаты:** Настройте автоматическое обновление сертификатов Let's Encrypt (см. [CERTBOT_SETUP.md](CERTBOT_SETUP.md))

## 📋 TODO / Планы развития

- [ ] **Автообновление сертификатов на сервере** — реализовать автоматическое обновление SSL сертификатов без ручного вмешательства
- [ ] **Список игроков с именами и фамилиями** — добавить вывод списка игроков по имени и фамилии, данные будут храниться рядом с конфигурацией
- [ ] **Отметка оплативших полный месяц** — рядом с именем каждого человека указывать тех, кто оплатил полный месяц, и всегда показывать их первыми в итоговом списке игроков
- [ ] **Система рейтинга игроков** — добавить возможность понижать рейтинг игроков, если они проголосовали, но не пришли. Рейтинг влияет на позицию в итоговом списке. Продумать механизм восстановления рейтинга
